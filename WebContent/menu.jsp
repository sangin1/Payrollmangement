   ...
   <c:when test='${msg.master == "1"}' >
      <nav  class="navbar  navbar-expand-sm  bg-light"> 
	    ...
	    <div class="col-sm-offset-2 col-sm-10">
	      <button type="button" class="btn btn-primary" onclick="location.href='${contextPath}/Payroll/severance.do'">로그아웃</button>
	    </div>
	  </div>
	</c:when>	 
	<c:when test='${msg.master == "0"}'>
	      <nav  class="navbar  navbar-expand-sm  bg-light"> 
			  <ul  class="navbar-nav">  
			    ...
			    <li  class="nav-item"> 
		      <a  class="nav-link"  onclick="location.href='${contextPath}/Emp/manager.do'">퇴직금관리</a> 
		    </li> 
			    <li class="nav-item"> 
			      <a class="nav-link" onclick="location.href='${contextPath}/Ann/manager.do'">연차관리</a> 
			    </li> 
