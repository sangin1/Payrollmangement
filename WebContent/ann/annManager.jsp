   ...
   <c:when test='${msg.master == "1"}' >
	...
	<form>
	  	<div class="form-group" align="left">
		    <div class="col-sm-offset-2 col-sm-10">
			  <button type="button" class="btn btn-primary" onclick="location.href='${contextPath}/Ann/searchAnn.do'">남은연차수</button>
			  <button type="button" class="btn btn-success" onclick="location.href='${contextPath}/Ann/addAnn.do'">연차등록(신청)</button>
			  <button type="button" class="btn btn-info" onclick="location.href='${contextPath}/Ann/checkAnn.do'">승인내역</button>
	  		</div>
	  	</div>
	</form>
</body> 
